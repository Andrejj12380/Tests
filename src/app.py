...
def show_all_docs_info():
	...
	all_doc_list = []
	for current_document in documents:
		all_doc_list.append(show_document_info(current_document))
	return all_doc_list


def add_new_doc(new_doc_number: str, new_doc_type: str, new_doc_owner_name: str, new_doc_shelf_number: str):
	new_doc = {
		"type": new_doc_type,
...
def secretary_program_start(user_command: str):
	"""
	...
	while True:
		if user_command == 'p':
			...
			return secretary_program_start.__doc__
		elif user_command == 'q':
			break
